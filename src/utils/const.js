// const
const MAPBOX_TOKEN = 'pk.eyJ1IjoibmF0Y2F0bW9kZWxpbmciLCJhIjoiY2lmcHBibmI5NmQ2dHMza3FmN3VhdnNveCJ9.cq75mgWIzoAaesbmdR6T6Q';
...
const ENGLISH_INFO_MESSAGE = (yearLength, year) => `NatCAT's running journey, ${yearLength} Years, and counting. See ${year} data below`;
